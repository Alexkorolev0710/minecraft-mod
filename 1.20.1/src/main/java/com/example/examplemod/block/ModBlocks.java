...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SEA_CORAL_BLOCK = registerBlock("sea_coral_block",
    ...
    public static final RegistryObject<Block> END_STONE_PEPEHA_ORE = registerBlock("end_stone_pepeha_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.END_STONE)
                    .strength(5f).requiresCorrectToolForDrops(), UniformInt.of(3, 7)));
    ...
    public static final RegistryObject<Block> FIREWORK = registerBlock("firework",
            ...
            () -> new FireworkBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.AMETHYST)));
